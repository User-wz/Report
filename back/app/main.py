...
from app.core.redis import get_redis_client, get_redis
...
# ========================================
# 说明: 入口
# 开发阶段启动命令：uvicorn app.main:app --host 192.168.3.16 --port 8000 --reload --workers 4 --worker-class uvicorn.workers.UvicornWorker
...
def get_application() -> FastAPI:
    ...
    """
    application.include_router(api_router, prefix=f"/api/{settings.VERSION}")
    # 挂载静态文件
